...
export const WebsiteInner: React.FC<WebsiteInnerProps> = ({ websiteName, pageType, href }) => {
  return (
    <div className="flex flex-col">
      ...
      <section className="w-[90%] flex items-center justify-between m-auto mt-8">
        <span className={`${styles.small_text} dark:text-white`}>Страницы сайта</span>
        <Link className="text-primary" href="https://sparkstudio.kz/home">
          https://sparkstudio.kz/home
        </Link>
      </section>
      <WebsitePageTab name={websiteName} pageType={pageType} href={href} />
    </div>
  );
};
